...
public interface UserRecAdMapper {
     ...
     * @return
     */
    @Insert("insert into UserRecAdvertisement (commonId,ifRead,recAdTime,userId,departmentName,username) " +
            "values(#{commonId},#{ifRead},#{recAdTime},#{userId},#{departmentName},#{username})")
