...
public interface UserRecAdMapper {
     ...
     * @return
     */
    @Select("select c.adContent ad ,c.adTitle at,c.addUser addUser,u.recAdtime re,u.commonId,u.ifRead ifRead from UserRecAdvertisement u left join CommonAdvertisement c on u.commonId=c.id order by u.recAdtime DESC limit #{startSize},#{limit}")
